...
for previsto, real in zip(previsao_modelo_de_iowa, y_teste):
...
print("Segundo os testes o modelo teve: ")
print(f"Erro médio: ${erro_medio:.2f}") # Significa que, em média, o modelo erra o preço real da casa em cerca de X doláres... mede a diferença média entre o valor previsto e o valor real. Quanto menor esse número, melhor o modelo.
print(f"Qualidade do modelo (R²): {r2:.3f}") # Essa é a pontuação, indica o quanto o modelo explica as variações dos dados. O valor varia de 0 a 1
...
while resposta not in "sn" or resposta == "" or resposta == "sn":
    ...
    if resposta == "n":
        ...
        with open("modelo_treinado.pkl", "wb") as arquivo:
            pickle.dump(modelo_de_iowa, arquivo)
